...
public abstract class SpoutSession<T extends SpoutEngine> implements Session {
    ...
    private static final long spikeLatency = SpoutConfiguration.RECV_SPIKE_LATENCY.getLong();

    private static final float spikeChance = SpoutConfiguration.RECV_SPIKE_CHANCE.getFloat() / 20.0F;
